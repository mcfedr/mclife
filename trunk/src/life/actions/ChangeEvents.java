...
/**
 * Passes on change events to the current state
 *
 */
public class ChangeEvents implements ChangeListener {

	Events events;
	
	public ChangeEvents(Events e) {
		events = e;
	}
	public void stateChanged(ChangeEvent e) {
		events.getCurrentState().stateChanged(e);
	}
